...
<head>
    ...
    <!--[if lt IE 9]>
      ...
      <script src="https://oss.maxcdn.com/libs/respond.fontend/js/1.3.0/respond.min.js"></script>
    <![endif]-->
    <script>
                ...
                <ul class="nav product-list">
                  <li>
                    <div class="product-thumbnail">
                      <img src="fontend/images/shop/2.jpg" alt="">
                    </div>
                  ...
                  <li>
                    <div class="product-thumbnail">
                      <img src="fontend/images/shop/5.jpg" alt="">
                    </div>
                    <div class="product-summary">
