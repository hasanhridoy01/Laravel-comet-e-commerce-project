          ...
          <div class="row">
            <div class="col-md-6">
              <div data-options="{&quot;animation&quot;: &quot;slide&quot;, &quot;controlNav&quot;: true}" class="flexslider nav-inside control-nav-dark">
                <ul class="slides">
                  ...
                  <li>
                    <img src="{{ URL::to('/') }}/media/products/{{ $all_product -> image }}" alt="">
                  </li>
            ...
            <div class="col-md-5 col-md-offset-1">
              <div class="title mt-0">
                <h2>{{ $all_product -> name }}<span class="red-dot"></span></h2>
                @foreach( $all_product -> categoris as $cat )
                <p class="m-0">{{ $cat -> name }}</p> |
                @endforeach
                @foreach( $all_product -> tags as $tag )
              ...
              <div class="single-product-price">
                <div class="row">
                  <div class="col-xs-6">
                    <h3><del>{{ $all_product -> price }}</del><span>{{ $all_product -> price }}</span></h3>
                  </div>
