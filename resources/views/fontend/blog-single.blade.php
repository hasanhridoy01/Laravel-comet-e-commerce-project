...
<section class="page-title parallax">
      <div data-parallax="scroll" data-image-src="fontend/images/bg/15.jpg" class="parallax-bg"></div>
          ...
          <div class="col-md-8">
            <article class="post-single">
              ...
              <div class="post-media">
                <img src="fontend/images/blog/1.jpg" alt="">
              </div>
              <div class="post-body">
            ...
            <div id="comments">
              ...
              <ul class="comments-list">
                <li>
                  <div class="comment">
                    <div class="comment-pic">
                      <img src="fontend/images/team/1.jpg" alt="" class="img-circle">
                    </div>
                  ...
                  <ul class="children">
                    <li>
                      <div class="comment">
                        <div class="comment-pic">
                          <img src="fontend/images/team/2.jpg" alt="" class="img-circle">
                        </div>
                        <div class="comment-text">
                ...
                <li>
                  <div class="comment">
                    <div class="comment-pic">
                      <img src="fontend/images/team/3.jpg" alt="" class="img-circle">
                    </div>
                    <div class="comment-text">
